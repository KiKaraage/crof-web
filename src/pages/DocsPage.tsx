    ...
    <div className="px-8 pt-9 pb-0 h-full">
      <div className="container mx-auto max-w-4xl rounded-md h-[calc(100vh-8.5rem)] flex flex-col overflow-hidden relative">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">API/SDK</h2>
          <p className="mb-4">
...
for chunk in response:
    if chunk.choices and chunk.choices[0].delta.content:
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">Supported Parameters</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">AI models / API MODEL-NAME</h2>
          <p>These are available on the <a href="/pricing" className="text-primary hover:underline">/pricing page</a></p>
        </section>

        <section className="pb-6">
          <h2 className="text-2xl font-semibold mb-4">429 Error codes</h2>
          <p>
