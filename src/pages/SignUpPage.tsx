          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            <div className="w-full max-w-md">
              <div className="text-center mb-8">
                <h1 className="text-3xl font-bold mb-4 gradient-text">Sign Up</h1>
                <p className="text-muted-foreground">Join crofAI today</p>
              </div>
               ...
               <div className="w-full flex justify-center mt-6">
                 <Button onClick={() => { login(); navigate('/playground'); }} variant="default">
                  Bypass
                </Button>
              </div>
            </div>
